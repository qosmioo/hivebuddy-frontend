      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 mb-4 mb-md-0 text-start">
          ...
          <ul>
            ...
            <li>
              <a class="text-body">hivebuddy@bmstu.ru</a>
            </li>
            <li>
              <a href="#!" class="text-body">г. Москва, Рубцовская наб., 2/18, кафедра СГН-3</a>
            </li>
          </ul>
        </div>
        <div class="col-lg-6 col-md-6 mb-mt-4 mb-md-0 mt-4 text-start">
          ...
          <ul>
            ...
            <li>
              <a href="#!" class="text-body">Frontend - Фёдор Санин</a>
            </li>
            <li>
              <a href="#!" class="text-body">UI/UX - Камила Самиева</a>
            </li>
          </ul>
        </div>
      </div>
